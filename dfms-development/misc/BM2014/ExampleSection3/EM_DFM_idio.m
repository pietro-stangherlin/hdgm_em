...
A_new(1:r,1:r*p) = EZZ_FB(1:r,:)/EZZ_BB;
...
for i = 1:n_idio;
    ...
    B(i,i) = (res_i(1:end-1)'*res_i(1:end-1))\(res_i(1:end-1)')*res_i(2:end,:);
...
rp2 = (r*p)^2;
initV1 = reshape((eye(rp2)-kron(A,A))\Q(:),r*p,r*p);
