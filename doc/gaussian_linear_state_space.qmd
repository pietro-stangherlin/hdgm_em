...
Which hints to an increase the autoregressive order to at least 2 and or consider covariates transformations.
...
Addind and state space recursion for variance or use models such the extended Kalman Filter and Particle Filters[@DurbinKoopman] or consider the quantile dynamic models.
